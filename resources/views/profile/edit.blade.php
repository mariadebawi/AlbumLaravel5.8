...
@section('card')
    @component('components.card')
        @slot('title')
            ...
            <a href="{{ route('profile.destroy', $user->id) }}" class="btn btn-danger btn-sm float-right invisible" role="button" aria-disabled="true"><i class="fas fa-angry fa-lg"></i> @lang('Supprimer mon compte')</a>
        @endslot
